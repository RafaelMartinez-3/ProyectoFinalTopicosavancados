...
namespace Datos
{
    ...
    {
        /// <summary>
        /// Metodo para poder intentar ingresar con un usuario y una contraseña
        /// </summary>
        /// <param name="usuario">El usuario en el que queremos ingresar</param>
        /// <param name="password">La contraseña que nos ingreso</param>
        /// <returns>Una variable de tipo employee con los datos del usuario</returns>
        ...
        /// <summary>
        /// Metodo para tomar todos los datos de los empleados
        /// </summary>
        /// <returns>Regresa una lista de tipo employee con los datos de todos los empleados</returns>
        ...
        /// <summary>
        /// Metodo para insertar valores en la tabla de empleados
        /// </summary>
        /// <param name="emp">Variable de tipo Employee con los datos del empleado</param>
        ...
        /// <summary>
        /// Metodo para tomar todos los titulos de los empleados
        /// </summary>
        /// <returns>Regresa una lista de tipo string con los titulos</returns>
