...
namespace ProyectoFinalTap
{
    public partial class FrmCatalogoEmpleados : MetroForm
    {
        ...
        {
            //Llenamos el datagriview con los datos de los empleados
            emp = new EmployeeDAO().GetAll();
            dgvEmpleados.DataSource = emp;
        }
        ...
        {
            //Agregamos un nuevo empleado con los datos predefinidos como "null"
        ...
        {
            //Mandamos los valores de la fila seleccionada al formulario de agregar/editar un empleado
        ...
        {
            //Eliminamos el empleado que estemos seleccionando en el datagridview
            DataGridViewRow filaSeleccionada = dgvEmpleados.SelectedRows[0];
